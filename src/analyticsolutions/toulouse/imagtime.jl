...
function toulouse_Giw(spectrum::AbstractBoundedFunction; β::Real, ϵ_d::Real, μ::Real=0, n::Int=1000)
    return [toulouse_Giw(spectrum, x; ϵ_d=ϵ_d, μ=μ) for x in ifrequencies(β, n)]
end
toulouse_Giw(bath::AbstractFermionicNormalBath, ω::Real; kwargs...) = toulouse_Giw(bath.spectrum, ω; μ=bath.μ, kwargs...)


"""
    toulouse_Gτ(spectrum::AbstractBoundedFunction, τ::Real; β::Real, ϵ_d::Real, μ::Real, n::Int)
...
"""
function toulouse_Gτ(spectrum::AbstractBoundedFunction, τ::Real; β::Real, ϵ_d::Real, μ::Real=0., n::Int=1000)
    res = 0.0
...
toulouse_Gτ(bath::AbstractFermionicNormalBath, τ::Real; kwargs...) = toulouse_Gτ(bath.spectrum, τ; β=bath.β, μ=bath.μ, kwargs...)
function toulouse_Gτ(spectrum::AbstractBoundedFunction; β::Real, Nτ::Int, ϵ_d::Real, μ::Real=0., n::Int=1000)
    δτ = β / Nτ
...
toulouse_Gτ(bath::AbstractFermionicNormalBath; Nτ::Int, kwargs...) = toulouse_Gτ(bath.spectrum; β=bath.β, μ=bath.μ, Nτ=Nτ, kwargs...)
