...
toulouse_Gw(bath::AbstractFermionicNormalBath, ω::Real; kwargs...) = toulouse_Gw(bath.spectrum, ω; μ=bath.μ, kwargs...)
...
toulouse_Gt(bath::AbstractFermionicNormalBath, t::Real; kwargs...) = toulouse_Gt(bath.spectrum, t; μ=bath.μ, kwargs...)
