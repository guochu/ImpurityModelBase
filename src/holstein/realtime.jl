...
function holstein_Gw(f::AbstractSpectrumFunction, ϵ::Real; α::Real, ω::Real, ϵ_d::Real, μ::Real=0, δ::Real=1.0e-8, order::Int=10)
	x = 0.
	for o in order:-1:0
		x = holstein_Gw_util(f, ϵ, o, x, α=α, ω=ω, ϵ_d=ϵ_d, μ=μ, δ=δ)
	end
	return x
end
